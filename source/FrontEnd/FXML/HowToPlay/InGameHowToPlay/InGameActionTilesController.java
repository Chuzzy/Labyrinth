 ...
 * @version 1.0.
 */
public class InGameActionTilesController extends StateLoad {
    ...
    public void onIce() {
        ...
        wl = new WindowLoader(newGameButton);
        wl.load("/HowToPlay/InGameHowToPlay/Ice", getInitData());
    }
    ...
    public void onFire() {
        MAIN_MENU_AUDIO.play(Double.parseDouble(getInitData().get("SFXVol")));
        wl = new WindowLoader(newGameButton);
        wl.load("/HowToPlay/InGameHowToPlay/Fire", getInitData());
    }
    ...
    public void onDoubleMove() {
        MAIN_MENU_AUDIO.play(Double.parseDouble(getInitData().get("SFXVol")));
        wl = new WindowLoader(newGameButton);
        wl.load("/HowToPlay/InGameHowToPlay/Double Move", getInitData());
    }
    ...
    public void onBacktrack() {
        MAIN_MENU_AUDIO.play(Double.parseDouble(getInitData().get("SFXVol")));
        wl = new WindowLoader(newGameButton);
        wl.load("/HowToPlay/InGameHowToPlay/Backtrack", getInitData());
